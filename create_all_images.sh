...
bash ./create_image_variant.sh --variant certs --tag "${local_repo}:certs-${version}" --tag "${local_repo}:certs-latest" --tag "${local_repo}:certs-${timestamp}" --platform "$local_platform" --load
...
bash ./create_image_variant.sh --variant minimal --tag "${local_repo}:minimal-${version}" --tag "${local_repo}:minimal-latest" --tag "${local_repo}:minimal-${timestamp}" --platform "$local_platform" --load
...
bash ./create_image_variant.sh --variant base --tag "${local_repo}:base-${version}" --tag "${local_repo}:base-latest" --tag "${local_repo}:base-${timestamp}" --platform "$local_platform" --load
...
bash ./create_image_variant.sh --variant jdk --tag "${local_repo}:jdk-${version}" --tag "${local_repo}:jdk-latest" --tag "${local_repo}:jdk-${timestamp}" --platform "$local_platform" --load
...
bash ./create_image_variant.sh --variant full --tag "${local_repo}:full-${version}" --tag "${local_repo}:full-latest" --tag "${local_repo}:full-${timestamp}" --platform "$local_platform" --load
